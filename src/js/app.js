...
function mostrarSeccion() {
 ...
 function seleccionarServicio(servicio) {
    ...
    if( servicios.some( agregado => agregado.id === id ) ) { //El some se usa para saber si ya esta un objeto agregado
        //Eliminarlo
...
function idCliente() {
 ...
 function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        if( [6,0].includes(dia) ) { //El 0 es Domingo, el 6 es Sábado
            e.target.value = '';
 ...
 function mostrarAlerta(mensaje, tipo, elemento, desaparece = true) {
    ...
    //Previene que se creen más de 1 alerta
 ...
 function mostrarResumen() {
    ...
    if( Object.values(cita).includes('') || cita.servicios.length === 0 ) {
        mostrarAlerta('Faltan datos de servicos, fecha u hora', 'error', '.contenido-resumen', false);
